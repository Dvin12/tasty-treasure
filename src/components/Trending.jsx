...
function Trending({ trending }) {
  return (
    <main className="h-full w-full bg-gray-200">
      <section className="py-10 xl:mx-60 xl:px-2 xl:py-20">
        <div className="flex flex-col items-center justify-center xl:flex-row xl:justify-between">
          <div>
            <h2 className="mb-2 text-center text-xl font-semibold text-gray-900 xl:text-left xl:text-4xl">
              Current Trending Recipes
            </h2>
            <span className="text-sm font-medium text-gray-500 xl:text-lg">
      ...
      <section className="flex flex-col p-3 text-center xl:mx-60 xl:grid xl:grid-cols-3 xl:justify-items-center xl:gap-12 xl:p-0  xl:pb-28 xl:text-left">
        {trending.map((items) => (

  ...
  return (
    <section className="w-full  relative overflow-auto ">
      <img
        src={banner}
        alt=""
        className="  brightness-75  w-full  h-[400px] object-cover "
      />
      <article className="bg-gray-200 flex flex-col items-start justify-center absolute right-40 top-40 p-12 rounded-xl ">

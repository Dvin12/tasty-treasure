...
function Category() {
  return (
    <section className="">
      <div className="flex items-center justify-center xl:gap-12 gap-5  flex-wrap  ">
        <Link
          to="/recipes/Italian"
          className="xl:w-[300px] w-[170px]    relative flex items-center justify-center cursor-pointer overflow-hidden "
        >
          <img
            src={italian}
            alt="italian"

...
function Category() {
  return (
    <section className="">
      <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6   2xl:gap-12 ">
        <Link
          to="/recipes/Italian"
          className="relative flex    w-[160px] cursor-pointer items-center justify-center overflow-hidden md:w-[270px] 2xl:w-[300px] "
        >
          <img
            src={italian}
            alt="italian"

      ...
      <section className="relative mx-4 flex  h-auto flex-col items-center justify-center py-28 md:py-40 xl:mx-6  xl:grid  xl:w-auto xl:grid-cols-2  xl:py-60 2xl:mx-60 2xl:py-72">
        ...
        <article className="flex flex-col  items-center justify-center  xl:relative  xl:w-auto">
          <img
            src={dish1}
            alt="food"
            className=" absolute bottom-[-120px] left-8  w-48 md:bottom-[-180px] md:left-36 md:w-[280px] xl:bottom-[-80px] xl:left-0 xl:w-[340px] xl:drop-shadow-lg 2xl:bottom-[-120px] 2xl:w-[420px]"
          />
          <img
            src={dish2}
            alt="food"
            className=" absolute right-6 top-[550px] z-20  w-56 drop-shadow-lg md:right-32 md:top-[610px] md:w-[360px] xl:left-40 xl:top-[-170px] xl:w-[480px] 2xl:w-[580px]"
          />
        </article>
      </section>
    </header>

      ...
      <section className="relative flex h-fit  flex-col items-center justify-center px-4 py-28 xl:mx-60  xl:grid xl:w-fit xl:grid-cols-2 xl:py-80">
        ...
        <article className="   flex flex-col  items-center justify-center  xl:relative  xl:w-[800px]">
          <img
            src={dish1}
            alt="food"
            className=" absolute bottom-[-120px] left-8  w-48 xl:bottom-[-120px] xl:left-0 xl:w-[420px] xl:drop-shadow-lg"
          />
          <img
            src={dish2}
            alt="food"
            className=" absolute right-6 top-[550px] z-20  w-56 drop-shadow-lg xl:left-40 xl:top-[-170px] xl:w-[580px]"
          />
        </article>
      </section>
    </header>

  ...
  return (
    <section className="relative  w-full overflow-auto ">
      <img
        src={banner}
        alt=""
        className="  w-full  object-cover  brightness-75 md:h-[460px] 2xl:h-[560px] "
      />
      <article className="flex flex-col items-start justify-center bg-gray-200 p-16 text-center md:absolute md:right-28 md:top-32 md:rounded-xl md:p-12 xl:right-10 2xl:right-40  2xl:top-48">

...
function Trending({ trending }) {
  return (
    <main className="h-full w-full bg-gray-200">
      ...
      <section className="flex  flex-col items-center justify-center p-4 text-center  xl:mx-60 xl:grid xl:grid-cols-3 xl:justify-items-center xl:gap-12 xl:p-0  xl:pb-28 xl:text-left">
        {trending.map((items) => (
